			...
			<li class="nav-item dropdown"><a
				...
				<div class="dropdown-menu" aria-labelledby="pagesDropdown">
					<#list cat.sublist as subcat> <a
						...
						href="/mobile?category=${subcat.id}">${subcat.name}</a> </#list>
				</div></li>
			</#list>
		</ul>
						...
						<div class="input-group">
							...
							<div class="input-group-append">
								<button id="link_search"
									url="/mobile?category=${categoryId!}"
					...
					<nav aria-label="Page navigation example">
						...
						<ul class="pagination justify-content-end">
							<li
								...
								class="page-link"
								href="/mobile?category=${categoryId!}&keyword=${encodeKeyword!}&page=${page-1}">上一页</a></li>
							...
							<li
								...
								class="page-link"
								href="/mobile?category=${categoryId!}&keyword=${encodeKeyword!}&page=${i}">${i}</a></li>
							...
							<li
								...
								class="page-link"
								href="/mobile?category=${categoryId!}&keyword=${encodeKeyword!}&page=${page+1}">下一页</a></li>
						</ul>
					</nav>
